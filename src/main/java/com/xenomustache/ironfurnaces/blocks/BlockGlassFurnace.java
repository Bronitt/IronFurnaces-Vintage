...
public class BlockGlassFurnace
extends BlockContainer {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName() && (tileentity = worldIn.getTileEntity(pos)) instanceof TileEntityGlassFurnace) {
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        TileEntity tileentity;
        if (!TileEntityGlassFurnace.keepInventory && (tileentity = worldIn.getTileEntity(pos)) instanceof TileEntityGlassFurnace) {
