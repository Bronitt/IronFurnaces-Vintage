...
extends BlockContainer {
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
        ...
        if (stack.hasDisplayName() && (tileentity = worldIn.getTileEntity(pos)) instanceof TileEntityGoldFurnace) {
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        TileEntity tileentity;
        if (!TileEntityGoldFurnace.keepInventory && (tileentity = worldIn.getTileEntity(pos)) instanceof TileEntityGoldFurnace) {
