...
public class IFBlocks {
    ...
    public static void register(IForgeRegistry<Block> registry) {
        registry.registerAll(ironFurnaceIdle, ironFurnaceActive.setLightLevel(0.875f), goldFurnaceIdle, goldFurnaceActive.setLightLevel(0.875f), diamondFurnaceIdle, diamondFurnaceActive.setLightLevel(0.875f), glassFurnaceIdle, glassFurnaceActive.setLightLevel(0.875f), obsidianFurnaceIdle, obsidianFurnaceActive.setLightLevel(0.875f));
    }

    public static void registerItemBlocks(IForgeRegistry<Item> registry) {
        registry.registerAll(ironFurnaceIdle.createItemBlock(), ironFurnaceActive.createItemBlock(), goldFurnaceIdle.createItemBlock(), goldFurnaceActive.createItemBlock(), diamondFurnaceIdle.createItemBlock(), diamondFurnaceActive.createItemBlock(), glassFurnaceIdle.createItemBlock(), glassFurnaceActive.createItemBlock(), obsidianFurnaceIdle.createItemBlock(), obsidianFurnaceActive.createItemBlock());
    }
