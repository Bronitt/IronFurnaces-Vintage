...
import com.xenomustache.ironfurnaces.blocks.BlockGlassFurnace;
...
public class TileEntityGlassFurnace
...
ISidedInventory {
    ...
    public static boolean isItemFuel(ItemStack stack) {
        return TileEntityGlassFurnace.getItemBurnTime(stack) > 0;
    }
    ...
    public String getName() {
        return this.hasCustomName() ? this.furnaceCustomName : "container.furnace_3";
    }
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        this.currentItemBurnTime = TileEntityGlassFurnace.getItemBurnTime(this.furnaceItemStacks.get(1));
        ...
        if (!this.world.isRemote) {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !this.furnaceItemStacks.get(0).isEmpty()) {
                if (!this.isBurning() && this.canSmelt()) {
                    this.currentItemBurnTime = this.furnaceBurnTime = TileEntityGlassFurnace.getItemBurnTime(itemstack);
                    if (this.isBurning()) {
                        flag1 = true;
            ...
            if (flag != this.isBurning()) {
                ...
                keepInventory = true;
                if (flag1) {
                    this.world.setBlockState(this.pos, IFBlocks.glassFurnaceActive.getDefaultState().withProperty(BlockGlassFurnace.FACING, iblockstate.getValue(BlockGlassFurnace.FACING)), 3);
                    this.world.setBlockState(this.pos, IFBlocks.glassFurnaceActive.getDefaultState().withProperty(BlockGlassFurnace.FACING, iblockstate.getValue(BlockGlassFurnace.FACING)), 3);
                } else {
                    this.world.setBlockState(this.pos, IFBlocks.glassFurnaceIdle.getDefaultState().withProperty(BlockGlassFurnace.FACING, iblockstate.getValue(BlockGlassFurnace.FACING)), 3);
                    this.world.setBlockState(this.pos, IFBlocks.glassFurnaceIdle.getDefaultState().withProperty(BlockGlassFurnace.FACING, iblockstate.getValue(BlockGlassFurnace.FACING)), 3);
                }
                keepInventory = false;
                if (tileentity != null) {
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) {
        ...
        ItemStack itemstack = this.furnaceItemStacks.get(1);
        return TileEntityGlassFurnace.isItemFuel(stack) || SlotFurnaceFuel.isBucket(stack) && itemstack.getItem() != Items.BUCKET;
    }
