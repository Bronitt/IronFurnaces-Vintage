...
import com.xenomustache.ironfurnaces.blocks.BlockGoldFurnace;
...
public class TileEntityGoldFurnace
...
ISidedInventory {
    ...
    public static boolean isItemFuel(ItemStack stack) {
        return TileEntityGoldFurnace.getItemBurnTime(stack) > 0;
    }
    ...
    public String getName() {
        return this.hasCustomName() ? this.furnaceCustomName : "container.furnace_1";
    }
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        this.currentItemBurnTime = TileEntityGoldFurnace.getItemBurnTime(this.furnaceItemStacks.get(1));
        ...
        if (!this.world.isRemote) {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !this.furnaceItemStacks.get(0).isEmpty()) {
                if (!this.isBurning() && this.canSmelt()) {
                    this.currentItemBurnTime = this.furnaceBurnTime = TileEntityGoldFurnace.getItemBurnTime(itemstack);
                    if (this.isBurning()) {
                        flag1 = true;
            ...
            if (flag != this.isBurning()) {
                ...
                keepInventory = true;
                if (flag1) {
                    this.world.setBlockState(this.pos, IFBlocks.goldFurnaceActive.getDefaultState().withProperty(BlockGoldFurnace.FACING, iblockstate.getValue(BlockGoldFurnace.FACING)), 3);
                    this.world.setBlockState(this.pos, IFBlocks.goldFurnaceActive.getDefaultState().withProperty(BlockGoldFurnace.FACING, iblockstate.getValue(BlockGoldFurnace.FACING)), 3);
                } else {
                    this.world.setBlockState(this.pos, IFBlocks.goldFurnaceIdle.getDefaultState().withProperty(BlockGoldFurnace.FACING, iblockstate.getValue(BlockGoldFurnace.FACING)), 3);
                    this.world.setBlockState(this.pos, IFBlocks.goldFurnaceIdle.getDefaultState().withProperty(BlockGoldFurnace.FACING, iblockstate.getValue(BlockGoldFurnace.FACING)), 3);
                }
                keepInventory = false;
                if (tileentity != null) {
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) {
        ...
        ItemStack itemstack = this.furnaceItemStacks.get(1);
        return TileEntityGoldFurnace.isItemFuel(stack) || SlotFurnaceFuel.isBucket(stack) && itemstack.getItem() != Items.BUCKET;
    }
