...
import com.xenomustache.ironfurnaces.blocks.BlockObsidianFurnace;
...
public class TileEntityObsidianFurnace
...
ISidedInventory {
    ...
    public static boolean isItemFuel(ItemStack stack) {
        return TileEntityObsidianFurnace.getItemBurnTime(stack) > 0;
    }
    ...
    public String getName() {
        return this.hasCustomName() ? this.furnaceCustomName : "container.furnace_4";
    }
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        this.currentItemBurnTime = TileEntityObsidianFurnace.getItemBurnTime(this.furnaceItemStacks.get(1));
        ...
        if (!this.world.isRemote) {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !this.furnaceItemStacks.get(0).isEmpty()) {
                if (!this.isBurning() && this.canSmelt()) {
                    this.currentItemBurnTime = this.furnaceBurnTime = TileEntityObsidianFurnace.getItemBurnTime(itemstack);
                    if (this.isBurning()) {
                        flag1 = true;
            ...
            if (flag != this.isBurning()) {
                ...
                keepInventory = true;
                if (flag1) {
                    this.world.setBlockState(this.pos, IFBlocks.obsidianFurnaceActive.getDefaultState().withProperty(BlockObsidianFurnace.FACING, iblockstate.getValue(BlockObsidianFurnace.FACING)), 3);
                    this.world.setBlockState(this.pos, IFBlocks.obsidianFurnaceActive.getDefaultState().withProperty(BlockObsidianFurnace.FACING, iblockstate.getValue(BlockObsidianFurnace.FACING)), 3);
                } else {
                    this.world.setBlockState(this.pos, IFBlocks.obsidianFurnaceIdle.getDefaultState().withProperty(BlockObsidianFurnace.FACING, iblockstate.getValue(BlockObsidianFurnace.FACING)), 3);
                    this.world.setBlockState(this.pos, IFBlocks.obsidianFurnaceIdle.getDefaultState().withProperty(BlockObsidianFurnace.FACING, iblockstate.getValue(BlockObsidianFurnace.FACING)), 3);
                }
                keepInventory = false;
                if (tileentity != null) {
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) {
        ...
        ItemStack itemstack = this.furnaceItemStacks.get(1);
        return TileEntityObsidianFurnace.isItemFuel(stack) || SlotFurnaceFuel.isBucket(stack) && itemstack.getItem() != Items.BUCKET;
    }
